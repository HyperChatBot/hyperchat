...
const WaveformNew: FC<Props> = ({ filename }) => {
  const currPlayingAudioId = useAtomValue(currPlayingAudioIdAtom)
  const setCurrPlayingAudioId = useSetAtom(currPlayingAudioIdAtom)
