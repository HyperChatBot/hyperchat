    ...
    <section className="">
      <section className="flex items-center justify-between p-6">
        <section className="flex items-center">
          ...
          <span className="bg-default-badge pt-0.5 pr-2 pb-0.5 pl-2 font-semibold text-xs rounded-3xl">
            12
          </span>
        </section>
        <BoldAddIcon />
      ...
      <input
        type="text"
        className="mt-3 mr-6 mb-3 ml-6 pt-3 pr-2.5 pb-3 pl-2.5 bg-search-input rounded-xl w-75 text-sm text-black text-opacity-40  focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
      />
